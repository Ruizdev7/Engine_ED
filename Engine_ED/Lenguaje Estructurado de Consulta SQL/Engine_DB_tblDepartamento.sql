...
CREATE TABLE `tblDepartamento` (
  ...
  `descripcionDepartamento` varchar(25) NOT NULL,
  `idPais` char(2) NOT NULL,
  PRIMARY KEY (`idDepartamento`),
  KEY `fk_tblDepartamento_1_idx` (`idPais`),
  CONSTRAINT `fk_tblDepartamento_1` FOREIGN KEY (`idPais`) REFERENCES `tblPais` (`idPais`)
